...
func loadConfig() *Config {
	...
	flag.StringVar(&config.CertPath, "cert_path", "/Users/lkolluru/working-dir/apple/go-gcsproxy", "path to generated cert files")
	...
	flag.StringVar(&config.KmsResourceName, "kms_project", "projects/cmetestproj/locations/global/keyRings/gcsproxytest/cryptoKeys/gcsproxy", "Payload will be encrypted with keys stored in KMS")
